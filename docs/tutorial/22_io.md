...
Reads a line from stdin. Returns `Zero` at EOF.
...
Writes string to file (overwrites if exists). Returns number of bytes written.
...
All file operations return `Result<T, String>`:
- `Ok(value)` — success
...
| `fileWrite` | `(String, String) -> Result<Int, String>` | Write file |
| `fileAppend` | `(String, String) -> Result<Int, String>` | Append to file |
| `fileExists` | `(String) -> Bool` | Check file existence |
| `fileSize` | `(String) -> Result<Int, String>` | File size |
| `fileDelete` | `(String) -> Result<Nil, String>` | Delete file |
| `dirCreate` | `(String) -> Result<Nil, String>` | Create directory |
| `dirCreateAll` | `(String) -> Result<Nil, String>` | Create directory recursively |
| `dirRemove` | `(String) -> Result<Nil, String>` | Remove empty directory |
| `dirRemoveAll` | `(String) -> Result<Nil, String>` | Remove directory recursively |
| `dirList` | `(String) -> Result<List<String>, String>` | Directory contents |
